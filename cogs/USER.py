...
class USER(Cog):
    ...
    async def start(self,ctx):
        ...
        if cur.rowcount == 0:
            cur.execute(f"INSERT INTO Main (ID,MONEY,LEVEL,XP,BUFFS,WORKPLACE,WTIER,INCOME,LASTWORKED,STAMINA,MSTAMINA,HOUSE,HOUSESOWNED,FOODSOWNED,WSTREAK,DSTREAK,DAILY,DAILYELAPSED,VOTE,VSTREAK,HUNGER,SLEEPINESS) VALUES ({ctx.author.id},0,1,0,'[]','Fast Food',1,10,5,10,10,True,'Homeless','[]','[]',0,0,False,0,False,0,70,70);")
            con.commit()
